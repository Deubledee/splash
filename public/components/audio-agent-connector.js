...
class audioAgentConnector extends PolymerElement {
  static get template() {
    return html`
...
`;
  ...
  ready() {
   ...
   /*   this.draggable = true
      this.ondrag = event=>{
          console.log('ondrag', event.srcElement)
      }
      ...
      this.ondragend = event=>{
          console.log('ondragend', event.srcElement)
      } 
      this.ondragover = event=>{
          console.log('ondragover', event.srcElement)
      }
      this.ondrop = event=>{
          console.log('ondrop', event.srcElement)
      }*/
  }
